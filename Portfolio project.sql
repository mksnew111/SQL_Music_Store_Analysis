...
SELECT 
	c.first_name ||'_'|| c.last_name AS full_name, 
	SUM(i.total) 
FROM 
	customer c
LEFT JOIN invoice i
...
Rock Music listeners. Return Your list ordered alphabeticaaly by email starting
with A */
...
average song length. Return the Name and MIliseconds for each track.
...
determine the most popular genre as the genre with the hightest amount of
